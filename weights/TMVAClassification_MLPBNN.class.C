...
inline void ReadMLPBNN::Initialize()
{
   ...
   fWeightMatrix0to1[0][0] = -0.627530035282472;
   fWeightMatrix0to1[1][0] = 1.77098344147927;
   fWeightMatrix0to1[2][0] = 1.39768929796088;
   fWeightMatrix0to1[3][0] = 0.785897725443124;
   fWeightMatrix0to1[4][0] = -7.67042928255501;
   fWeightMatrix0to1[5][0] = 0.0140340689147582;
   fWeightMatrix0to1[6][0] = 0.119661454672523;
   fWeightMatrix0to1[7][0] = 0.500993828199907;
   fWeightMatrix0to1[8][0] = -0.986938997657564;
   fWeightMatrix0to1[0][1] = -0.00160058289879906;
   fWeightMatrix0to1[1][1] = -0.0245490313221833;
   fWeightMatrix0to1[2][1] = -0.0489702409096795;
   fWeightMatrix0to1[3][1] = -0.0498366099652652;
   fWeightMatrix0to1[4][1] = -0.996991783975061;
   fWeightMatrix0to1[5][1] = -0.112454126239785;
   fWeightMatrix0to1[6][1] = -0.00492466245005063;
   fWeightMatrix0to1[7][1] = 0.0200476594223002;
   fWeightMatrix0to1[8][1] = 0.367902615299431;
   fWeightMatrix0to1[0][2] = -0.19018075134708;
   fWeightMatrix0to1[1][2] = 0.349244470301283;
   fWeightMatrix0to1[2][2] = -0.338832714893747;
   fWeightMatrix0to1[3][2] = 0.308025348326332;
   fWeightMatrix0to1[4][2] = -2.32439535622925;
   fWeightMatrix0to1[5][2] = 0.139221181664453;
   fWeightMatrix0to1[6][2] = -0.0410570881742304;
   fWeightMatrix0to1[7][2] = -0.382824219146375;
   fWeightMatrix0to1[8][2] = 1.11712550289075;
   fWeightMatrix0to1[0][3] = -0.683646278117192;
   fWeightMatrix0to1[1][3] = -1.83676377106656;
   fWeightMatrix0to1[2][3] = -1.68088755415129;
   fWeightMatrix0to1[3][3] = -1.31309710348325;
   fWeightMatrix0to1[4][3] = 11.4766155280249;
   fWeightMatrix0to1[5][3] = -1.71652919399387;
   fWeightMatrix0to1[6][3] = 0.434916036413139;
   fWeightMatrix0to1[7][3] = -0.49264434880571;
   fWeightMatrix0to1[8][3] = -0.173998395831395;
   fWeightMatrix0to1[0][4] = -1.95261445046158;
   fWeightMatrix0to1[1][4] = 1.41597453345008;
   fWeightMatrix0to1[2][4] = 0.067396636654404;
   fWeightMatrix0to1[3][4] = 0.937372828033485;
   fWeightMatrix0to1[4][4] = -0.666921552633004;
   fWeightMatrix0to1[5][4] = 0.0772968118761761;
   fWeightMatrix0to1[6][4] = 1.82683216433101;
   fWeightMatrix0to1[7][4] = 1.72933086824061;
   fWeightMatrix0to1[8][4] = -0.685587411956847;
   // weight matrix from layer 1 to 2
   fWeightMatrix1to2[0][0] = -0.095035633443088;
   fWeightMatrix1to2[0][1] = 0.342206319369492;
   fWeightMatrix1to2[0][2] = 0.561782409724783;
   fWeightMatrix1to2[0][3] = 0.26155861464914;
   fWeightMatrix1to2[0][4] = 0.698221518881891;
   fWeightMatrix1to2[0][5] = -0.149094080602111;
   fWeightMatrix1to2[0][6] = 0.176793065742049;
   fWeightMatrix1to2[0][7] = 0.0294271713070999;
   fWeightMatrix1to2[0][8] = 0.429319312521212;
   fWeightMatrix1to2[0][9] = 0.0149335861578633;
}
